...
export const resizetab = () => {
  ...
  tableBox.style.height = Content.offsetHeight - tablePosi.offsetHeight - inputBox.offsetHeight - tablePage.offsetHeight - 120 +'px';
  tableBody.style.height = Content.offsetHeight - tablePosi.offsetHeight - inputBox.offsetHeight - tablePage.offsetHeight - 160 +'px';
  atb[0].style.height = tableBody.style.height;
  atb[1].style.height = tableBody.style.height;
  console.log(  tableBox.style.height)
  return tableHeight = (tableBox.style.height).slice(0,-2);
};
